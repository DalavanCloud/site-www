...
`homepage`
: Optional. URL poiting to the package's homepage (or source code repository).
...
While this is technically optional *please do* provide either a `homepage`
or a `repository`. It helps users understand where your package is coming from.
